...
const AddToLikedBtn = ({ variant, children }: Props) => {
  ...
  return (
    <button
      ...
      className="flex items-center gap-1 p-1 border border-1 border-red-400 rounded-lg text-red-400 hover:text-white bg-white hover:bg-red-400 shadow  duration-300"
    >
      {children}
      {liked ? (
